...
comp-emitter-access-locked = Доступ до {$target}заблоковано!
...
comp-emitter-not-anchored = {$target}не прикріплений до землі!

emitter-component-current-type = Поточний вибраний тип: [color=yellow]{$type}[/color].
emitter-component-type-set = Тип встановлено на: {$type}