...
anomaly-scanner-severity-percentage-unknown = Поточний рівень серйозності: [color=red]ПОМИЛКА[/color]
...
anomaly-scanner-point-output-unknown = Вихід точки: [color=red]ПОМИЛКА[/color]
...
anomaly-gorilla-charge-infinite = Він має [color=gold]нескінченні заряди[/color]. [italic]Поки...[/italic]
...
anomaly-sync-disconnect-verb-text = Відокремити аномалію
anomaly-sync-disconnect-verb-message = Від'єднайте підключену аномалію від {THE($machine)}.
...
anomaly-behavior-point = [color=gold]Аномалія дає {$mod}% балів[/color]

anomaly-behavior-safe = [color=forestgreen]Аномалія надзвичайно стабільна. Надзвичайно рідкісна пульсація.[/color]
anomaly-behavior-slow = [color=forestgreen]Частота пульсацій значно менша.[/color]
anomaly-behavior-light = [color=forestgreen]Потужність пульсації значно зменшена.[/color]
anomaly-behavior-balanced = Відхилень у поведінці не виявлено.
anomaly-behavior-delayed-force = Частота пульсацій значно зменшується, але збільшується їх потужність.
anomaly-behavior-rapid = Частота пульсації значно вища, але її сила ослаблена.
anomaly-behavior-reflect = Виявлено захисне покриття.
anomaly-behavior-nonsensivity = Виявлено слабку реакцію на частинки.
anomaly-behavior-sensivity = Була виявлена ​​посилена реакція на частинки.
anomaly-behavior-invisibility = Виявлено спотворення світлової хвилі.
anomaly-behavior-secret = Виявлено перешкоди. Деякі дані неможливо прочитати
...
anomaly-secret-admin = [color=red](ПОМИЛКА)[/color]