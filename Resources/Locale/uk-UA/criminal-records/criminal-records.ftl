...
criminal-records-console-flavor-left = Артефакт
...
criminal-records-status-eliminated = Ліквідований
...
criminal-records-console-hostile = {$name}({$job}) було позначено як вороже {$officer}для: {$reason}.
criminal-records-console-not-hostile = {$name}({$job}) більше не позначено як ворожі {$officer}.
criminal-records-console-eliminated = {$name}({$job}) було позначено як вилучене {$officer}.
criminal-records-console-not-eliminated = {$name}({$job}) {$officer}більше не позначено як видалені.
...
criminal-records-species-filter = види
