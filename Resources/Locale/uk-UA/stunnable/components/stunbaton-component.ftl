...
comp-stunbaton-examined-on = Індикатор зараз [color=darkgreen]увімкнено[/color].
comp-stunbaton-examined-off = Світло зараз [color=darkred]вимкнено[/color]
...
stunbaton-component-on-examine = Індикатор зараз [color=darkgreen]увімкнено[/color].
