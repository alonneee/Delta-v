...
analysis-console-info-locked-value = [font="Monospace" size=11][color=__FLUENT_MASK_0__[/color][/font]
analysis-console-info-durability = [font="Monospace" size=11]Стійкість:[/font]
analysis-console-info-durability-value = [font="Monospace" size=11][color=__FLUENT_MASK_0__]{$current}/{$max}[/color][/font]
