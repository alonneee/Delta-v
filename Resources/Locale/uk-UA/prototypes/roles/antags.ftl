...
roles-antag-syndicate-agent-sleeper-name = Сплячий агент Syndicate
...
roles-antag-paradox-clone-objective = Чудова просторово-часова аномалія телепортувала вас в іншу реальність! Тепер вам потрібно знайти свого аналога, убити і замінити його.
...
roles-antag-mothership-core-name = Ядро Ксеноборга
