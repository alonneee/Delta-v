...
general-station-record-console-no-record-found = Для вибраної особи не знайдено жодного запису.
...
general-station-record-species-filter = види
general-station-record-prints-filter = Відбитки пальців
general-station-record-dna-filter = Типи ролей
