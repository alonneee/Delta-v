...
add-uplink-command-completion-3 = Чи ввімкнено знижку на висхідний канал
add-uplink-command-error-1 = Вибраний гравець не контролює жодну сутність
add-uplink-command-error-2 = Не вдалося додати висхідне посилання до програвача