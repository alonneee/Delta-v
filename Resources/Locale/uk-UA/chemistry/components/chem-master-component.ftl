...
chem-master-output-beaker-draw = Макс.: { 0 }u
chem-master-window-no-beaker-text = Стакан не завантажений
chem-master-window-beaker-empty-text = Стакан порожній
chem-master-window-beaker-low-text = Недостатньо розчину в склянці
chem-master-output-source = Джерело упаковки:
